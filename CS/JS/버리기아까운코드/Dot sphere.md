...
### change element from window to specific div
```javascript
window.innerWidth => document.getElementById("specific_div_id").offsetWidth;
window.innerHeight => document.getElementById("specific_div_id").offsetHeight;
```